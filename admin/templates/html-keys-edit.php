	...
	<table id="api-keys-options" class="form-table">
		<tbody>
			...
			<tr valign="top">
				...
				<td class="forminp">
					...
					$user_string    = sprintf(
						...
						esc_html__( '%1$s (#%2$s &ndash; %3$s)', 'wp-event-manager-organizer-app-access' ),
						$user->display_name,
						absint( $user->ID ),
						$user->user_email
					);
					?>
					<select class="wpem-customer-search" id="key_user" data-placeholder="<?php esc_attr_e( 'Search for a user&hellip;', 'wp-event-manager-organizer-app-access' ); ?>" data-allow_clear="true">
			...
			<tr valign="top">
				<th scope="row" class="titledesc">
					<label for="key_permissions">
						<?php esc_html_e( 'Permissions', 'wp-event-manager-organizer-app-access' ); ?>
						<?php   _e( 'Select the access type of these keys.', 'wp-event-manager-organizer-app-access' ); ?>
					</label>
				</th>
				<td class="forminp">
					<select id="key_permissions" class="wpem-enhanced-select">
						<?php
						$permissions = array(
							'read'       => __( 'Read', 'wp-event-manager-organizer-app-access' ),
							'write'      => __( 'Write', 'wp-event-manager-organizer-app-access' ),
							'read_write' => __( 'Read/Write', 'wp-event-manager-organizer-app-access' ),
						);
			...
			<?php if ( 0 !== $key_id ) : ?>
				<tr valign="top">
					<th scope="row" class="titledesc">
						<?php esc_html_e( 'Consumer key ending in', 'wp-event-manager-organizer-app-access' ); ?>
					</th>
					<td class="forminp">
				...
				<tr valign="top">
					<th scope="row" class="titledesc">
						<?php esc_html_e( 'Last access', 'wp-event-manager-organizer-app-access' ); ?>
					</th>
					<td class="forminp">
						<span>
						<?php
...
<script type="text/template" id="tmpl-api-keys-template">
	...
	<table class="form-table">
		<tbody>
			<tr valign="top">
				<th scope="row" class="titledesc">
					<?php esc_html_e( 'Consumer key', 'wp-event-manager-organizer-app-access' ); ?>
				</th>
				<td class="forminp">
			...
			<tr valign="top">
				<th scope="row" class="titledesc">
					<?php esc_html_e( 'Consumer secret', 'wp-event-manager-organizer-app-access' ); ?>
				</th>
				<td class="forminp">
