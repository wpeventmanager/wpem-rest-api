...
class WPEM_REST_APP_Branding_Controller extends WPEM_REST_CRUD_Controller
{
        ...
        register_rest_route(
            ...
            array(
                array(
                    ...
                    'callback' => array($this, 'wpem_get_branding_settings'),
                    'permission_callback' => array($this, 'wpem_get_items_permissions_check'),
                )
            )
        );
    }
    ...
    /**
     * function wpem_get_branding_settings
     *
     * @since 1.0.0
     * @param 
     */
    public function wpem_get_branding_settings()
    {
